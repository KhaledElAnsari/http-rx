...
Node$1.prototype.initialise = function initialise () {
		var this$1 = this;
...
Node$1.prototype.minify = function minify ( code ) {
		var this$1 = this;
...
var ArrayExpression = (function (Node) {
	...
	ArrayExpression.prototype.minify = function minify ( code ) {
		...
		Node.prototype.minify.call( this, code );
	};
...
var ArrowFunctionExpression = (function (Node) {
	...
	ArrowFunctionExpression.prototype.initialise = function initialise () {
		...
		Node.prototype.initialise.call(this);
	};
